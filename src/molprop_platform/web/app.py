...
st.set_page_config(page_title="MolScope Server", layout="wide")

st.title("MolScope Server")
st.caption(
...
with tab_about:
    st.subheader("About")
    st.markdown("""
MolScope Server is designed to keep MolProp Toolkit intact by remaining table-first and additive.
